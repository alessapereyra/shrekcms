    ...
    <div id="<?php echo $id; ?>" class="top_news_featured">
    	<div class="top_news_content">
			...
			<?php
				...
				<?php }?>	
				<span class="author">enviado por
					<a href="http://lamula.pe/members/<?php echo $post['user_login']; ?>" >
					<?php echo $post['user_nicename']; ?>
					</a> 
					<em> el <?php echo $post['post_date'] ?></em>
				</span>
		</div>
...
<?php  for ($x=$tot; $x<$max; $x++):?>
	<div id="<?php echo $id; ?>" class="top_news_featured">&nbsp;</div>
	<?php $id = next($ids);?>
<?php endfor; ?>
