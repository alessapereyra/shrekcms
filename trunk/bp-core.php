...
if ( file_exists( BP_PLUGIN_DIR . '/bp-languages/buddypress-es_ES.mo' ) ) 
	load_textdomain( 'buddypress', BP_PLUGIN_DIR . '/bp-languages/buddypress-es_ES.mo' );
