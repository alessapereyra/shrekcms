		...
		<?php if ( function_exists( 'bp_activity_get_list' ) ) : ?>
			...
			<?php 
				bp_activity_get_list( 
					...
					bp_word_or_name( __( "Mi actividad", 'buddypress' ), __( "Actividad de %s", 'buddypress' ), true, false ), // The title of the activity list.
					bp_word_or_name( __( "Aun no has hecho nada.", 'buddypress' ), __( "%s no ha hecho nada aun.", 'buddypress' ), true, false ) // What to show when there is no activity.
				);
			?>
