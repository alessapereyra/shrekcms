...
<table border="0" cellpadding="2" cellspacing="0" width="100%">
  <tr>
    ...
    <td align="right"><?php GDSRHelper::render_templates_section("WSR", $this->get_field_name('template_id'), $instance["template_id"], 260); ?>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="right">
        <label><select name="<?php echo $this->get_field_name('grouping'); ?>" id="<?php echo $this->get_field_id('grouping'); ?>" style="width: 130px">
