...
?>
  <div id="sidebars">
      ...
      <a href="<?php bloginfo('siteurl'); ?>/tag/bagua">
        <img src="http://lamula.pe/wp-content/themes/lamula/images/banner.gif" class="sidebox_image" id="bagua" alt="Seguimiento #bagua" title="Seguimiento #bagua"/>
      </a>

      <a href="http://lamula.lamula.pe/?p=53#respond">
          <img src="http://lamula.pe/wp-content/themes/lamula/images/comentarios.png" class="sidebox_image" id="comentarios_banner" alt="Dejanos tus comentarios" title="Dejanos tus comentarios"/>
      </a>
