...
<?php foreach ($comments as $comment) : ?>
	...
	<?php comment_text() ?>
	<p><cite><?php comment_type(_c('Comment|noun'), __('Trackback'), __('Pingback')); ?> <?php _e('by'); ?> <?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></mimulate> <?php edit_comment_link(__("Edit This"), ' |'); ?></p>
	</li>
